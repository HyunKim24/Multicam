...
nums[0] = 2
print(nums)
# 범위 변경 -> 범위 개수가 값의 개수가 다른 경우
# 그 범위값은 대입하는 값을 치환 (개수가 줄어들수도 있다)
...
print(nums)
###########################################################################
# 정렬 => 원본 조작 (웬만하면 사본에서 정렬하는게 유리함)
nums = [32,54,6,3,12,4,6,4,3,21,4,6,7,4,2,36757,6,3,2,1]
nums.sort()
# 오름차순
print(nums)
